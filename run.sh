...
# 设置macOS特定的环境变量
export QTWEBENGINE_CHROMIUM_FLAGS="--disable-web-security --disable-features=VizDisplayCompositor"
...
# 启动应用程序
echo "启动应用程序..."
echo "使用环境变量: QTWEBENGINE_CHROMIUM_FLAGS=$QTWEBENGINE_CHROMIUM_FLAGS"
python3 main.py
